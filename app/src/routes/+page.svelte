	...
	<div class="section-hero build-in-animate relative overflow-hidden">
		...
		<div class="hero-artwork absolute top-0 hidden md:relative md:block">
			...
			<div class="absolute inset-0">
				...
				<picture>
					<img
						src={baseUrl + '/images/kubernates.png'}
						width="200"
						height="200"
						loading="lazy"
						decoding="async"
...
<div class="bg-image-custom overflow-x-clip px-5 py-10">
...
<div class="mx-auto max-w-screen-xl px-5 py-10 ">
	<div class="grid gap-10 md:grid-cols-2 lg:grid-cols-5 px-5">
		...
		<div
			class="card-service group bg-gray-50 p-6 shadow ring-1 ring-gray-200/50 transition-all hover:shadow-lg lg:col-span-3"
		>
			<div class="mb-2">
				<h3 class="mt-2 text-center text-xl font-medium lg:text-2xl">
					<span>Platform Engineering</span>
				</h3>
				<p class="mt-3 text-center text-slate-600 [text-wrap:balance]">
					<span>
			...
			<div class="relative mt-4 flex h-auto items-start justify-center overflow-hidden lg:h-80">
				<div class="absolute inset-0 z-10 via-transparent"></div>
	...
	<div class="mt-10 grid gap-10 md:grid-cols-3 lg:grid-cols-3">
		<div
			class="card-service group relative bg-gray-50 p-6 shadow ring-1 ring-gray-200/50 transition-all hover:shadow-lg"
		>
			<div class="bt-2">
				<h3 class="mt-2 text-center text-xl font-medium lg:text-2xl">
			...
			<div class="relative mt-4 flex h-auto items-start justify-center overflow-hidden lg:h-60">
				<div class="absolute inset-0 z-10 via-transparent"></div>
		...
		<div
			class="card-service group bg-gray-50 p-6 shadow ring-1 ring-gray-200/50 transition-all hover:shadow-lg"
		>
			<div class="mb-2">
				<h3 class="mt-2 text-center text-xl font-medium lg:text-2xl">
					<span>Product Modernization</span>
				</h3>
				<p class="mt-3 text-center text-slate-600 [text-wrap:balance]">
					<span>
						Empowering your business with tailored tech solutions, transparent communication, and a
			...
			<div
				class="text-centermt-4 relative flex h-auto items-start justify-center overflow-hidden lg:h-60"
			>
				<div class="absolute inset-0 z-10 via-transparent"></div>
...
<div class="mx-auto max-w-screen-xl px-5 pt-10 pb-5">
	...
	<div class="logosInfiniteSection mt-5">
			...
			<div class="logosInfiniteScrolling">
				<div class="logosInfiniteScrollingImg">
					<img
						...
						src={baseUrl + '/images/cloudinary.svg'}
					/>
				</div>
				<div class="logosInfiniteScrollingImg">
					<img
...
<div class="mx-auto max-w-screen-xl px-5">
	...
	<div class="mt-10 grid gap-8 sm:grid-cols-2 md:grid-cols-3 md:gap-16">
		<Card
		...
		<Card
			...
			icon='<svg width="24" height="24" viewBox="0 0 24 24" class="text-theme" data-icon="fluent:box-24-regular"><symbol id="ai:fluent:box-24-regular"><path fill="currentColor" d="M10.591 2.513a3.75 3.75 0 0 1 2.818 0l7.498 3.04A1.75 1.75 0 0 1 22 7.175v9.653a1.75 1.75 0 0 1-1.093 1.621l-7.498 3.04a3.75 3.75 0 0 1-2.818 0l-7.498-3.04A1.75 1.75 0 0 1 2 16.827V7.176a1.75 1.75 0 0 1 1.093-1.622zm2.254 1.39a2.25 2.25 0 0 0-1.69 0L9.24 4.68l7.527 2.927l2.669-1.03zm1.846 4.505L7.215 5.5L4.59 6.564l7.411 2.882zM3.5 16.828a.25.25 0 0 0 .156.231l7.499 3.04c.031.013.063.025.095.036v-9.371L3.5 7.75zm9.345 3.271l7.499-3.04a.25.25 0 0 0 .156-.232V7.774l-7.75 2.992v9.37a2.18 2.18 0 0 0 .095-.036"></path></symbol><use xlink:href="#ai:fluent:box-24-regular"></use></svg>'
		/>
...
<div class="mx-auto max-w-screen-xl px-5 py-10">
	...
	<div class="relative overflow-x-clip">
		...
		<div class="group relative gap-10 overflow-hidden py-5 md:flex">
			...
			>
				<div
					class="relative flex w-[calc(100vw-5.75rem)] max-w-md shrink-0 snap-start snap-always scroll-m-5 flex-col justify-between bg-gray-50/60 p-8 shadow ring-1 ring-gray-200/50 backdrop-blur-md transition-all first-of-type:scroll-m-10 hover:shadow-lg"
				>
					...
					<blockquote class="text-lg [text-wrap:balance] md:text-xl">
						Improwised has transformed the way we manage our projects. Its well-designed interface
				...
				>
					...
					>
					<blockquote class="text-lg [text-wrap:balance] md:text-xl">
						Improwised has revolutionized the way we handle customer support. The ticketing system
				...
				>
					...
					>
					<blockquote class="text-lg [text-wrap:balance] md:text-xl">
						Improwised has been a lifesaver for our finance department. Its robust accounting
...
<div class="mx-auto max-w-screen-xl  px-5 py-10">
	...
	<div class="grid gap-10 md:grid-cols-2 lg:grid-cols-6">
		<div class="lg:col-span-4">
			...
			<h2 class="text-4xl font-bold lg:text-5xl lg:tracking-tight">
				Get in Touch <span class="text-theme">with Us</span>
			</h2>
